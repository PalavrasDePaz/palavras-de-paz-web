...
export const bookEditFormSchema = yup.object().shape({
  ...
  isAppropriation: yup.string().required(REQUIRED_FIELD),
  ...
  isParcialPlagiarism: yup.string().required(REQUIRED_FIELD),
