        ...
        <Box width="88%" margin="auto" direction="column">
          <div>
            <Typography
              ...
              fontSize="24px"
              align="start"
              text="Temos como objetivo, através de nosso programa, ajudar as pessoas a acessarem suas ferramentas internas para  encontrar a própria paz. A principal maneira que estamos disseminando o programa é a partir de parcerias com instituições de todos os setores, como, por exemplo:"
            />
          </div>
          ...
          <div>
            <Typography
              ...
              fontSize="24px"
              align="start"
              text="O Programa é uma série de workshops que ajudam as pessoas a descobrirem a própria força interior e paz pessoal, sendo encorajados a compartilharem seus entendimentos sobre os temas e escreverem suas reflexões. Dando assim, a oportunidade de refletirem sobre si mesmo e sobre seus recursos interiores como    escolha, esperança e dignidade."
            />
          </div>
        ...
        >
          <div>
            <Typography
              ...
              margin="0 0 40px 0"
              fontSize="24px"
              text="Ficaremos muito felizes com a possibilidade de trabalharmos juntos e sermos parceiros nessa jornada de resgate da humanidade!"
            />
          </div>
          <Button
            margin="0 0 20px 0"
