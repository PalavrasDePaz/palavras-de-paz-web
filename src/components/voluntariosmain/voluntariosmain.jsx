        ...
        <container className="voluntarios-principal">
          <div className="voluntarios-container-main">
            ...
            <div className="voluntarios-text">
              <p>Avaliador de Cadernos de detentos que fazem o curso de Educação para Paz;
          ...
          <container className="voluntarios-container-main">
            ...
            <div className="voluntarios-text">
              <p>Ter mais de 18 anos;
                ...
                Capacidade de trabalhar em equipe.</p>
            </div>
          </container>
        </container>
        <div className='voluntarios-botton'>
          <p>Se você quer fazer parte
            da equipe, se cadastre, mesmo que não tenha feito qualquer workshop, nossa equipe entrará em contato. Outra opção é se inscrever pelo Atados.</p>
        </div>
