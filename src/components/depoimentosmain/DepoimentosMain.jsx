    ...
    <>
      ...
      <container className="depoimentos-principal-solo">
        <div className="depoimentos-container-main-solo">
          ...
          <div className="depoimentos-photos-solo">
            <Image src="/static/images/depo_5.png" width="100%" height="100%" />
          </div>

          <div className="depoimentos-text-solo">
            <p>
              Hoje, lembrando os primeiros dias do nosso voluntariado, e contabilizando tudo, percebo a riqueza que essa atitude trouxe a minha vida e também para todos os que vivem em torno de mim. Temos dois aspectos de evolução que acontece: um interno e outro externo.
              Primeiro você entende a dimensão dessa Paz que te inunda as horas, você passa a respirar essa paz, e ela impregna seus pensamentos e suas atitudes! E depois que você se alista neste voluntariado da Paz, você é, e se sente um ser humano muito melhor, com maior consciência, maior apreciação da vida a cada dia!
              Porém, é quando você vê a mudança na conduta do outro, aquele onde a paz chega e chacoalha tudo, com crescimento interior e que se irradia para o exterior, aí você se vê, se identifica nessa mesma humanidade, e se alegra por ter-se permitido essa doação de si.
              Nesse voluntariado, nós vemos a alegria de partilhar ao invés de acumular, num desejo do bem, da fraternidade e da ternura que clamam em nosso coração para se manifestar.

              <br />
              <b>Cleide/Voluntária</b>
            </p>
          </div>
      ...
      <container className="depoimentos-principal">
        <div className="depoimentos-container-main">
          ...
          <div className="depoimentos-photos">
            <Image src="/static/images/depo_6.png" width="100%" height="100%" />
          </div>

          <div className="depoimentos-text">
            <p>
              A Paz, seguramente uma das causas mais antigas.
              Por isso, ter a Palavras de Paz em nossa Rede Social é, primeiro, uma honra! Para nós do Instituto União Solidária que promovemos a cultura do trabalho em rede desde 2005, uma organização que promova essa causa de forma estruturada, e com paixão fortalece muito nosso trabalho. Nossa colaboração tem gerado ainda mais impacto positivo!

              <br />
              <b>Regina Vizoso/Parceira/Instituto União Solidária</b>
            </p>
          </div>
      ...
      <container className="depoimentos-principal-solo">
        <div className="depoimentos-container-main-solo">
          ...
          <div className="depoimentos-photos-solo">
            <Image src="/static/images/depo_8.png" width="100%" height="100%" />
          </div>
